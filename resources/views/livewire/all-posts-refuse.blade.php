            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="mt-3">
                            <span class="badge bg-purple-lt" data-toggle="tooltip" title="Phản hồi: {{$post->updated_at->format('d/m/Y')}}"> {{ $post->author->name }}</span>
                        </div>
                    </div>
                    <div class="d-flex">
                        <a href="{{ route('author.posts.refuse-post',['post_id'=>$post->id]) }}" class="card-btn">
                        ...
                        <a href="" wire:click.prevent='deletePostRefuse({{ $post->id }})'  class="card-btn">
