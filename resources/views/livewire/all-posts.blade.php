        ...
        @forelse ($posts as $post)
            <div class="col-md-6 col-lg-3"  >
                <div class="card">
                    ...
                    <img data-toggle="tooltip" title="{{$post->post_title}}" src="/storage/images/post_images/thumbnails/resized_{{ $post->featured_image }}" alt=""
                        class="img-show-activepost card-img-top">
                    <div class="card-body p-2">
                        ...
                        <div class="mt-3">
                            <span class="badge bg-purple-lt" data-toggle="tooltip" title="Đã viết: {{$post->created_at->format('d/m/Y') }}"> {{ $post->author->name }}</span>
                    ...
                    <div class="d-flex">
                        ...
                        <a href="{{ route('author.posts.edit-post', ['post_id' => $post->id]) }}" class="card-btn">
                            <svg  class="icon icon-tabler icon-tabler-trash text-danger" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <a href="" wire:click.prevent='deletePost({{ $post->id }})' class="card-btn">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="icon icon-tabler icon-tabler-trash text-danger" width="24" height="24"
