<div style="width: 600px; margin: 0 auto; " >
    <div style="text-align: center">
        ...
        <p>
            <a href="{{ route('active-account-user',['token'=>$token,'email'=>$email ]) }}" style="display: inline-block; background: green;color: #fff;padding: 7px 25px; font-weight: bold">Kích Hoạt Tài Khoản</a>
        </p>
    </div>
