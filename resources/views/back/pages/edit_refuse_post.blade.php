...
@section('content')
    ...
    <form action="{{ route('author.posts.update-post-refuse', ['post_id' => Request('post_id')]) }}" method="Post"
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div style="mb-3">
                            <a class="text-decoration-none" href="{{ route('author.posts.all_posts_refuse') }}"><button
