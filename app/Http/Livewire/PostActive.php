...
class PostActive extends Component
{
    ...
    {
        return view('livewire.post-active',[
    ...
    public function deleteActivePost($id)
    {
        $this->dispatchBrowserEvent('deleteActivePost', [
            'title' => 'Bạn có chắc ?',
    ...
    public function deleteActivePostAction($id)
    {
        $post = Post::find($id);
